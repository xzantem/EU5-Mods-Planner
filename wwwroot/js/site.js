const translations = {
  en: {
    ...
    "country-modal-title-edit": "Edit tag",
    ...
    "save-country-edit": "Save changes",
    "close-archived-tags": "Close",
  ...
  pl: {
    ...
    "auth-signedin-title": "Zalogowano",
    "auth-signedin-copy": "Twoje konto jest obecnie tylko do odczytu.",
    ...
    "auth-register-copy": "Nowe konta zaczynają jako użytkownicy tylko do odczytu. Administrator może później nadać im wyższe uprawnienia.",
    ...
    "edit-culture-group": "Edytuj grupę kulturową",
    "archive-culture-group": "Archiwizuj grupę kulturową",
    "restore-culture-group": "Przywróć grupę kulturową",
    "edit-culture": "Edytuj kulturę",
    "archive-culture": "Archiwizuj kulturę",
    "restore-culture": "Przywróć kulturę",
    ...
    "situation-description-placeholder": "Długotrwałe napięcia zaczynają przenikać do codziennej polityki.",
    "situation-monthly-spawn-chance": "Miesięczna szansa pojawienia się (%)",
    "situation-can-start": "Może się rozpocząć",
    "situation-can-start-placeholder": "stability < 0",
    "situation-visible": "Widoczna, gdy",
    "situation-visible-placeholder": "has_country_flag = fractured_realm",
    "situation-can-end": "Może się zakończyć",
    "situation-can-end-placeholder": "stability >= 1",
    "situation-on-start-effects": "Efekty na początku",
    "situation-on-monthly-effects": "Efekty miesięczne",
    "situation-on-ending-effects": "Efekty przy wygaszaniu",
    "situation-on-ended-effects": "Efekty po zakończeniu",
    "situation-actions": "Akcje sytuacji",
    "add-situation-action": "Dodaj akcję",
    "remove-action": "Usuń akcję",
    "situation-action-title": "Akcja",
    "situation-action-name": "Nazwa akcji",
    "situation-action-name-placeholder": "Zmień stronę",
    ...
    "situation-action-cost-placeholder": "10 Stabilności i Honoru",
